...
def parse_pdb_file(file_path):
    ...
    with open(file_path, 'r') as pdb_file:
        for line in pdb_file:
            if (line.startswith("ATOM") or line.startswith("HETATM")) and line[21] in {'A', 'B'}:
...
def make_predictions(model, features):
    print("Making predictions using the neural network model...")
...
if __name__ == "__main__":
    ...
    print("Parsing PDB file to get coordinates...")
    ...
    print("Generating spheres and making predictions...")
